...
Complete reference for all 29 documentation files.
...
| File | What It Covers |
|---|---|
| `INDIA_MARKETS_SPEC.md` | NSE EQ, NSE F&O, MCX — lot sizes, expiry, margin, circuit breakers |
| `DATA_SCHEMA_INDIA.md` | TimescaleDB schema, all tables, retention policy |
| `INGESTION_PIPELINE_SPEC.md` | 7 EOD jobs, 4 live loops, TrueData ingestion pipeline |
...
```
INDIA_MARKETS_SPEC.md → CONTINUOUS_CONTRACTS_SPEC.md
→ Zerodha_Spec.md → SEGMENT_MODULES.md
```

---

## Complete File Status (29 files)
...
| 20 | DATA_SCHEMA_INDIA.md | ✅ Current |
| 21 | INGESTION_PIPELINE_SPEC.md | ✅ Current |
| 22 | TRUEDATA_SPEC.md | ✅ Current |
| 23 | CONTINUOUS_CONTRACTS_SPEC.md | ✅ Current |
| 24 | Zerodha_Spec.md | ✅ Current |
| 25 | ALLOCATOR_SPEC.md | ✅ Current |
| 26 | OPTIONS.md | ✅ Phase 2 ref |
| 27 | QUICK_REFERENCE.md | ✅ Current |
| 28 | LEARNING_ROADMAP.md | ✅ Current |
| 29 | INDEX.md | ✅ This file |
